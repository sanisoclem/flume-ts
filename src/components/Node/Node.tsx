...
const Node = ({
  ...
  const updateConnectionsByTransput = (transput: Record<string,any[]> = {}, isOutput: boolean = false) => {
  ...
  const stopDrag = (e: any, coordinates: any) => {
    nodesDispatch({
...
const NodeHeader = ({ children, className = "", ...props }: any) => (
