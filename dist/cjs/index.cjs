...
PortalWithState.propTypes = {
  ...
  node: propTypesExports.any,
  closeOnEsc: propTypesExports.bool,
  closeOnOutsideClick: propTypesExports.bool,
...
var ContextMenu = function (_a) {
    ...
    var _c = __read(React.useState(""), 2), filter = _c[0], setFilter = _c[1];
    var _d = __read(React.useState(0), 2), menuWidth = _d[0], setMenuWidth = _d[1];
    var _e = __read(React.useState(0), 2), selectedIndex = _e[0], setSelectedIndex = _e[1];
    ...
    var handleKeyDown = function (e) {
        ...
        if (e.which === 38) {
            ...
            if (selectedIndex === null) {
                ...
                setSelectedIndex(function (i) { return (i === null ? null : i - 1); });
            }
        }
        // Down pressed
        if (e.which === 40) {
    ...
    return (React.createElement("div", { "data-flume-component": "ctx-menu", className: styles$c.menuWrapper, onMouseDown: function (e) { return e.stopPropagation(); }, onKeyDown: handleKeyDown, style: {
            left: x,
            top: y,
        ...
        !hideHeader && (label ? true : !!options.length) ? (React.createElement("div", { className: styles$c.menuHeader, "data-flume-component": "ctx-menu-header" },
            React.createElement("label", { className: styles$c.menuLabel, "data-flume-component": "ctx-menu-title" }, label),
            !hideFilter && options.length ? (React.createElement("input", { "data-flume-component": "ctx-menu-input", type: "text", placeholder: "Filter options", value: filter, onChange: handleFilterChange, className: styles$c.menuFilter, autoFocus: true, ref: filterInput })) : null)) : null,
        React.createElement("div", { "data-flume-component": "ctx-menu-list", className: styles$c.optionsWrapper, role: "menu", ref: menuOptionsWrapper, style: { maxHeight: clamp_1(window.innerHeight - y - 70, 10, 300) } },
            ...
            !options.length ? (React.createElement("span", { "data-flume-component": "ctx-menu-empty", className: styles$c.emptyText }, emptyText)) : null)));
};
var ContextOption = function (_a) {
    ...
    return (React.createElement("div", { "data-flume-component": "ctx-menu-option", className: styles$c.option, role: "menuitem", onClick: onClick, onMouseEnter: onMouseEnter, "data-selected": selected, id: "".concat(menuId, "-").concat(index) }, children));
};

var NodeTypesContext = React.createContext(undefined);
var PortTypesContext = React.createContext(undefined);
var NodeDispatchContext = React.createContext(undefined);
var ConnectionRecalculateContext = React.createContext(undefined);
var ContextContext = React.createContext(undefined);
var StageContext = React.createContext(undefined);
var CacheContext = React.createContext(undefined);
var RecalculateStageRectContext = React.createContext(undefined);
var EditorIdContext = React.createContext(undefined);

function Draggable(_a) {
    var children = _a.children, stageState = _a.stageState, stageRect = _a.stageRect, onDragDelayStart = _a.onDragDelayStart, onDragStart = _a.onDragStart, onDrag = _a.onDrag, onDragEnd = _a.onDragEnd, onMouseDown = _a.onMouseDown, onTouchStart = _a.onTouchStart, disabled = _a.disabled, _b = _a.delay, delay = _b === void 0 ? 6 : _b, innerRef = _a.innerRef, rest = __rest(_a, ["children", "stageState", "stageRect", "onDragDelayStart", "onDragStart", "onDrag", "onDragEnd", "onMouseDown", "onTouchStart", "disabled", "delay", "innerRef"]);
    var wrapper = React.useRef(null);
    var startCoordinates = React.useRef();
    ...
    return (React.createElement("div", __assign({ onMouseDown: function (e) {
            if (!disabled) {
                startDragDelay(e);
            }
            if (onMouseDown) {
...
var Stage = function (_a) {
    ...
    var _b = __read(React.useState(false), 2), menuOpen = _b[0], setMenuOpen = _b[1];
    var _c = __read(React.useState({ x: 0, y: 0 }), 2), menuCoordinates = _c[0], setMenuCoordinates = _c[1];
    var dragData = React.useRef({ x: 0, y: 0 });
    var _d = __read(React.useState(false), 2), spaceIsPressed = _d[0], setSpaceIsPressed = _d[1];
    ...
    var handleWheel = React.useCallback(function (e) {
        ...
        dispatchStageState(function (_a) {
            var currentScale = _a.scale, currentTranslate = _a.translate;
            var delta = e.deltaY;
            var newScale = lodashExports.clamp(currentScale - lodashExports.clamp(delta, -10, 10) * 0.005, 0.1, 7);
            var byOldScale = function (no) { return no * (1 / currentScale); };
            var byNewScale = function (no) { return no * (1 / newScale); };
    ...
    var menuOptions = React.useMemo(function () {
        var options = orderBy_1(Object.values(nodeTypes)
    ...
    return (React.createElement(Draggable, { "data-flume-component": "stage", id: "".concat(STAGE_ID).concat(editorId), className: styles$d.wrapper, innerRef: wrapper, onContextMenu: handleContextMenu, onMouseEnter: handleMouseEnter, onDragDelayStart: handleDragDelayStart, onDragStart: handleDragStart, onDrag: handleMouseDrag, onDragEnd: handleDragEnd, onKeyDown: handleKeyDown, tabIndex: -1, stageState: { scale: scale, translate: translate }, style: { cursor: spaceIsPressed && spaceToPan ? "grab" : "" }, disabled: disablePan || (spaceToPan && !spaceIsPressed), "data-flume-stage": true },
        ...
        React.createElement("div", { ref: translateWrapper, className: styles$d.transformWrapper, style: { transform: "translate(".concat(-translate.x, "px, ").concat(-translate.y, "px)") } },
            React.createElement("div", { className: styles$d.scaleWrapper, style: { transform: "scale(".concat(scale, ")") } }, children)),
        outerStageChildren));
};

var styles$b = ".wrapper{\r\n  background: rgba(91, 96, 99, 0.9);\r\n  border-radius: 5px;\r\n  box-shadow: 0px 4px 8px rgba(0,0,0,.4);\r\n  position: absolute;\r\n  left: 0px;\r\n  top: 0px;\r\n  user-select: none;\r\n  display: flex;\r\n  flex-direction: column;\r\n  z-index: 1;\r\n  cursor: default;\r\n}\r\n.label{\r\n  font-size: 13px;\r\n  text-transform: uppercase;\r\n  padding: 5px;\r\n  background: #464b4e;\r\n  border-radius: 5px 5px 0px 0px;\r\n  margin: 0px;\r\n  margin-bottom: 3px;\r\n  border-bottom: 1px solid rgba(0,0,0,.15);\r\n}\r\n";
...
var createSVG = function (_a) {
    var from = _a.from, to = _a.to, stage = _a.stage, id = _a.id, outputNodeId = _a.outputNodeId, outputPortName = _a.outputPortName, inputNodeId = _a.inputNodeId, inputPortName = _a.inputPortName;
    var svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    svg.setAttribute("class", styles$a.svg);
    var path = document.createElementNS("http://www.w3.org/2000/svg", "path");
    var curve = calculateCurve(from, to);
    path.setAttribute("d", curve !== null && curve !== void 0 ? curve : '');
...
var createConnections = function (nodes, _a, editorId) {
        ...
        Object.values(nodes).forEach(function (node) {
            if (node.connections && node.connections.inputs) {
                Object.entries(node.connections.inputs).forEach(function (_a, k) {
                    var _b = __read(_a, 2), inputName = _b[0], outputs = _b[1];
...
var TextInput = function (_a) {
    ...
    return (React.createElement("div", { className: styles$6.wrapper, "data-flume-component": "text-input" }, type === "number" ? (React.createElement("input", { "data-flume-component": "text-input-number", onKeyDown: function (e) {
            if (e.keyCode === 69) {
                e.preventDefault();
                return false;
            }
        ...
        }, step: step || "1", onMouseDown: handlePossibleResize, type: type || "text", placeholder: placeholder, className: styles$6.input, defaultValue: data, onDragStart: function (e) { return e.stopPropagation(); }, ref: numberInput })) : (React.createElement("textarea", { "data-flume-component": "text-input-textarea", onChange: function (e) { return onChange(e.target.value); }, onMouseDown: handlePossibleResize, placeholder: placeholder, className: styles$6.input, value: data, onDragStart: function (e) { return e.stopPropagation(); } }))));
};

var styles$5 = ".wrapper{\r\n  font-size: 14px;\r\n  padding: 3px 6px;\r\n  border-radius: 4px;\r\n  background: linear-gradient(to top, #5b5f62, #6f7477);\r\n  width: 100%;\r\n  border: 1px solid #3c3e40;\r\n  padding-right: 15px;\r\n  position: relative;\r\n  &::after{\r\n    content: \"\";\r\n    position: absolute;\r\n    background: none;\r\n    right: 5px;\r\n    top: 8px;\r\n    width: 0;\r\n    height: 0;\r\n    border-style: solid;\r\n    border-width: 6px 5px 0 5px;\r\n    border-color: #191b1c transparent transparent transparent;\r\n  }\r\n  &:hover{\r\n    background: linear-gradient(to top, #63676a, #777b7e);\r\n  }\r\n}\r\n.chipWrapper{\r\n  font-size: 14px;\r\n  padding: 3px 6px;\r\n  border-radius: 4px;\r\n  background: linear-gradient(to top, #5b5f62, #6f7477);\r\n  border: 1px solid #3c3e40;\r\n  margin: 2px;\r\n  position: relative;\r\n}\r\n.chipWrapper:hover .deleteButton{\r\n  opacity: 1;\r\n}\r\n.chipsWrapper{\r\n  display: flex;\r\n  flex-direction: column;\r\n  margin-bottom: 6px;\r\n}\r\n.deleteButton{\r\n  position: absolute;\r\n  right: 0px;\r\n  top: 0px;\r\n  height: 100%;\r\n  width: 22px;\r\n  padding: 0px;\r\n  display: flex;\r\n  justify-content: center;\r\n  align-items: center;\r\n  background: linear-gradient(to top, #5b5f62, #6f7477);\r\n  border-radius: 3px;\r\n  border: none;\r\n  font-weight: bold;\r\n  opacity: 0;\r\n}\r\n.deleteButton:focus{\r\n  opacity: 1;\r\n}\r\n.deleteButton:hover{\r\n  background: linear-gradient(to top, #64696c, #797f82);\r\n}\r\n.selectedWrapper{\r\n  display: flex;\r\n  flex-direction: column;\r\n  border-radius: 4px;\r\n  background: linear-gradient(to top, #5b5f62, #6f7477);\r\n  width: 100%;\r\n  border: 1px solid #3c3e40;\r\n  font-size: 14px;\r\n  padding: 3px 6px;\r\n  padding-right: 15px;\r\n  position: relative;\r\n  &::after{\r\n    content: \"\";\r\n    position: absolute;\r\n    background: none;\r\n    right: 5px;\r\n    top: calc(50% - 4px);\r\n    width: 0;\r\n    height: 0;\r\n    border-style: solid;\r\n    border-width: 6px 5px 0 5px;\r\n    border-color: #191b1c transparent transparent transparent;\r\n  }\r\n  label{\r\n    margin: 0px;\r\n  }\r\n  p{\r\n    margin: 0px;\r\n    margin-top: 5px;\r\n    font-size: 12px;\r\n    font-style: italic;\r\n    color: rgb(50, 50, 50);\r\n  }\r\n}\r\n";
...
var Select = function (_a) {
    ...
    var _d = __read(React.useState(false), 2), drawerOpen = _d[0], setDrawerOpen = _d[1];
    var _e = __read(React.useState({
        x: 0,
        y: 0
    }), 2), drawerCoordinates = _e[0], setDrawerCoordinates = _e[1];
    ...
    var handleOptionSelected = function (option) {
        if (allowMultiple) {
            onChange(__spreadArray(__spreadArray([], __read(data), false), [option.value], false));
        }
        else {
    ...
    var handleOptionDeleted = function (optionIndex) {
        onChange(__spreadArray(__spreadArray([], __read(data.slice(0, optionIndex)), false), __read(data.slice(optionIndex + 1)), false));
    };
    ...
    var selectedOption = React.useMemo(function () {
        ...
        if (option) {
            return __assign(__assign({}, option), { label: option.label.length > MAX_LABEL_LENGTH
                    ? option.label.slice(0, MAX_LABEL_LENGTH) + "..."
                    : option.label });
        }
    }, [options, data]);
    return (React.createElement(React.Fragment, null,
        allowMultiple ? (data.length ? (React.createElement("div", { className: styles$5.chipsWrapper }, data.map(function (val, i) {
        ...
        (allowMultiple || !data) &&
            React.createElement("div", { className: styles$5.wrapper, ref: wrapper, onClick: openDrawer }, placeholder),
...
var SelectedOption = function (_a) {
    var _b = _a.option, _c = _b === void 0 ? { label: null, description: null } : _b, label = _c.label, description = _c.description, wrapperRef = _a.wrapperRef, onClick = _a.onClick;
    return (React.createElement("div", { className: styles$5.selectedWrapper, onClick: onClick, ref: wrapperRef, "data-flume-component": "select" },
...
var OptionChip = function (_a) {
    ...
    return (React.createElement("div", { className: styles$5.chipWrapper },
        children,
        React.createElement("button", { className: styles$5.deleteButton, onMouseDown: function (e) {
                e.stopPropagation();
...
var Control = function (_a) {
    ...
    var getControlByType = function (type) {
        ...
        switch (type) {
            case "select":
                return (React.createElement(Select, __assign({}, commonProps, { options: getOptions ? getOptions(inputData, executionContext) : options, placeholder: placeholder })));
            case "text":
                return React.createElement(TextInput, __assign({}, commonProps, { placeholder: placeholder }));
            case "number":
                return (React.createElement(TextInput, __assign({}, commonProps, { step: step, type: "number", placeholder: placeholder })));
            case "checkbox":
                return React.createElement(Checkbox, __assign({}, commonProps, { label: calculatedLabel }));
            case "multiselect":
                return (React.createElement(Select, __assign({ allowMultiple: true }, commonProps, { options: getOptions ? getOptions(inputData, executionContext) : options, placeholder: placeholder, label: label })));
            case "custom":
    ...
    return (React.createElement("div", { className: styles$8.wrapper, "data-flume-component": "control" },
        calculatedLabel && type !== "checkbox" && type !== "custom" && (React.createElement("label", { "data-flume-component": "control-label", className: styles$8.controlLabel }, calculatedLabel)),
        getControlByType(type)));
};

var Connection = function (_a) {
    var from = _a.from, to = _a.to, id = _a.id, lineRef = _a.lineRef, outputNodeId = _a.outputNodeId, outputPortName = _a.outputPortName, inputNodeId = _a.inputNodeId, inputPortName = _a.inputPortName;
    var curve = calculateCurve(from, to);
    return (React.createElement("svg", { className: styles$a.svg, "data-flume-component": "connection-svg" },
        React.createElement("path", { "data-connection-id": id, "data-output-node-id": outputNodeId, "data-output-port-name": outputPortName, "data-input-node-id": inputNodeId, "data-input-port-name": inputPortName, "data-flume-component": "connection-path", stroke: "rgb(185, 186, 189)", fill: "none", strokeWidth: 3, strokeLinecap: "round", d: curve, ref: lineRef })));
};
...
function useTransputs(transputsFn, transputType, nodeId, inputData, connections) {
    ...
    React.useEffect(function () {
        ...
        try {
            for (var prevTransputs_1 = __values(prevTransputs), prevTransputs_1_1 = prevTransputs_1.next(); !prevTransputs_1_1.done; prevTransputs_1_1 = prevTransputs_1.next()) {
                var transput = prevTransputs_1_1.value;
                _loop_1(transput);
            }
        }
        catch (e_1_1) { e_1 = { error: e_1_1 }; }
            ...
            try {
                if (prevTransputs_1_1 && !prevTransputs_1_1.done && (_a = prevTransputs_1["return"])) _a.call(prevTransputs_1);
            }
            finally { if (e_1) throw e_1.error; }
        }
...
var IoPorts = function (_a) {
    ...
    return (React.createElement("div", { className: styles$9.wrapper, "data-flume-component": "ports" },
        resolvedInputs.length ? (React.createElement("div", { className: styles$9.inputs, "data-flume-component": "ports-inputs" }, resolvedInputs.map(function (input) { return (React.createElement(Input, __assign({}, input, { data: inputData[input.name] || {}, isConnected: !!connections.inputs[input.name], triggerRecalculation: triggerRecalculation, updateNodeConnections: updateNodeConnections, inputTypes: inputTypes, nodeId: nodeId, inputData: inputData, key: input.name }))); }))) : null,
        !!resolvedOutputs.length && (React.createElement("div", { className: styles$9.outputs, "data-flume-component": "ports-outputs" }, resolvedOutputs.map(function (output) { return (React.createElement(Output, __assign({}, output, { triggerRecalculation: triggerRecalculation, inputTypes: inputTypes, nodeId: nodeId, inputData: inputData, portOnRight: true, key: output.name }))); })))));
};
var Input = function (_a) {
    ...
    return (React.createElement("div", { "data-flume-component": "port-input", className: styles$9.transput, "data-controlless": isConnected || noControls || !controls.length, onDragStart: function (e) {
            e.preventDefault();
            e.stopPropagation();
        } },
        ...
        (!controls.length || noControls || isConnected) && (React.createElement("label", { "data-flume-component": "port-label", className: styles$9.portLabel }, label || defaultLabel)),
        !noControls && !isConnected
            ? (React.createElement("div", { className: styles$9.controls }, controls.map(function (control) { return (React.createElement(Control, __assign({}, control, { nodeId: nodeId, portName: name, triggerRecalculation: triggerRecalculation, updateNodeConnections: updateNodeConnections, inputLabel: label, data: data[control.name], allData: data, key: control.name, inputData: inputData, isMonoControl: controls.length === 1 }))); })))
            : null));
};
var Output = function (_a) {
    ...
    return (React.createElement("div", { "data-flume-component": "port-output", className: styles$9.transput, "data-controlless": true, onDragStart: function (e) {
            e.preventDefault();
            e.stopPropagation();
        } },
        React.createElement("label", { "data-flume-component": "port-label", className: styles$9.portLabel }, label || defaultLabel),
...
var Port = function (_a) {
    ...
    var inputTypes = React.useContext(PortTypesContext);
    var _d = __read(React.useState(false), 2), isDragging = _d[0], setIsDragging = _d[1];
    var _e = __read(React.useState({
        x: 0,
        y: 0
    }), 2), dragStartCoordinates = _e[0], setDragStartCoordinates = _e[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { style: { zIndex: 999 }, onMouseDown: handleDragStart, className: styles$9.port, "data-port-color": color, "data-port-name": name, "data-port-type": type, "data-port-transput-type": isInput ? "input" : "output", "data-node-id": nodeId, "data-flume-component": "port-handle", onDragStart: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }, ref: port }),
...
var Node = function (_a) {
    ...
    var _d = __read(React.useState(false), 2), menuOpen = _d[0], setMenuOpen = _d[1];
    var _e = __read(React.useState({ x: 0, y: 0 }), 2), menuCoordinates = _e[0], setMenuCoordinates = _e[1];
    var byScale = function (value) { return (1 / stageState.scale) * value; };
    var updateConnectionsByTransput = function (transput, isOutput) {
        ...
        Object.entries(transput).forEach(function (_a) {
            var _b = __read(_a, 2), portName = _b[0], outputs = _b[1];
            outputs.forEach(function (output) {
    ...
    var stopDrag = function (e, coordinates) {
        nodesDispatch(__assign(__assign({ type: "SET_NODE_COORDINATES" }, coordinates), { nodeId: id }));
    };
    ...
    return (React.createElement(Draggable, { className: styles$b.wrapper, style: {
            width: width,
            transform: "translate(".concat(x, "px, ").concat(y, "px)")
        }, onDragStart: startDrag, onDrag: handleDrag, onDragEnd: stopDrag, innerRef: nodeWrapper, "data-node-id": id, "data-flume-component": "node", onContextMenu: handleContextMenu, stageState: stageState, stageRect: stageRect },
        ...
        menuOpen ? (React.createElement(Portal$1, null,
            React.createElement(ContextMenu, { x: menuCoordinates.x, y: menuCoordinates.y, options: __spreadArray([], __read((deletable !== false
                    ? [
                        {
                            label: "Delete Node",
                            value: "deleteNode",
                    ...
                    : [])), false), onRequestClose: closeContextMenu, onOptionSelected: handleMenuOption, hideFilter: true, label: "Node Options", emptyText: "This node has no options." }))) : null));
};
...
var buildControlType = function (defaultConfig, validate, setup) {
    if (validate === void 0) { validate = function (e) { }; }
    if (setup === void 0) { setup = function (e) { return ({}); }; }
    return function (config) {
        validate(config);
        return __assign({ type: defaultConfig.type, label: define(config.label, defaultConfig.label || ""), name: define(config.name, defaultConfig.name || ""), defaultValue: define(config.defaultValue, defaultConfig.defaultValue), setValue: define(config.setValue, undefined) }, setup(config));
    };
};
var Controls = {
...
var FlumeConfig = /** @class */ (function () {
    function FlumeConfig(config) {
        if (config) {
            this.nodeTypes = __assign({}, config.nodeTypes);
            this.portTypes = __assign({}, config.portTypes);
        }
        else {
            this.nodeTypes = {};
            this.portTypes = {};
    ...
    FlumeConfig.prototype.addRootNodeType = function (config) {
        this.addNodeType(__assign(__assign({}, config), { root: true, addable: false, deletable: false }));
        return this;
    };
    ...
    FlumeConfig.prototype.removeNodeType = function (type) {
        if (!this.nodeTypes[type]) {
            ...
            var _a = this.nodeTypes, _b = type; _a[_b]; var nodeTypes = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
    ...
    FlumeConfig.prototype.removePortType = function (type, _a) {
        ...
        if (!this.portTypes[type]) {
            ...
            if (affectedNodes.length) {
                ...
                var _d = this.portTypes, _e = type; _d[_e]; var portTypes = __rest(_d, [typeof _e === "symbol" ? _e : _e + ""]);
...
var ColorPicker = (function (_a) {
    ...
    return (React.createElement("div", { "data-flume-component": "color-picker", ref: wrapper, className: styles$3.wrapper, style: {
            left: x,
            top: y
...
var ColorButton = function (_a) {
    ...
    return (React.createElement("div", { className: styles$3.colorButtonWrapper },
        React.createElement("button", { "data-flume-component": "color-button", className: styles$3.colorButton, onClick: onSelected, "data-color": color, "aria-label": color })));
};
...
function Comment(_a) {
    ...
    var _b = __read(React.useState(false), 2), isEditing = _b[0], setIsEditing = _b[1];
    var _c = __read(React.useState(false), 2), isPickingColor = _c[0], setIsPickingColor = _c[1];
    var _d = __read(React.useState(false), 2), menuOpen = _d[0], setMenuOpen = _d[1];
    var _e = __read(React.useState({ x: 0, y: 0 }), 2), menuCoordinates = _e[0], setMenuCoordinates = _e[1];
    var _f = __read(React.useState({
        x: 0,
        y: 0
    }), 2), colorPickerCoordinates = _f[0], setColorPickerCoordinates = _f[1];
    var handleContextMenu = function (e) {
        e.preventDefault();
        e.stopPropagation();
        setMenuCoordinates({ x: e.clientX, y: e.clientY });
    ...
    var handleResize = function (coordinates) {
        var width = lodashExports.clamp(coordinates.x - x + 10, 80, 10000);
        var height = lodashExports.clamp(coordinates.y - y + 10, 30, 10000);
    ...
    return (React.createElement(Draggable, { innerRef: wrapper, className: styles$4.wrapper, style: {
            transform: "translate(".concat(x, "px,").concat(y, "px)"),
            width: width,
            height: height,
            zIndex: isEditing ? 999 : ""
        }, stageState: stageState, stageRect: stageRect, onDragStart: startDrag, onDrag: handleDrag, onDragEnd: handleDragEnd, onContextMenu: handleContextMenu, onDoubleClick: startTextEdit, onWheel: function (e) { return e.stopPropagation(); }, "data-color": color, "data-flume-component": "comment" },
        isEditing ? (React.createElement("textarea", { "data-flume-component": "comment-textarea", className: styles$4.textarea, onChange: handleTextChange, onMouseDown: function (e) { return e.stopPropagation(); }, onBlur: endTextEdit, placeholder: "Text of the comment...", autoFocus: true, value: text, ref: textarea })) : (React.createElement("div", { "data-flume-component": "comment-text", "data-comment": true, className: styles$4.text }, text)),
        React.createElement(Draggable, { className: styles$4.resizeThumb, stageState: stageState, stageRect: stageRect, onDrag: handleResize, onDragEnd: handleResizeEnd, "data-flume-component": "comment-resize-handle" }),
        menuOpen ? (React.createElement(Portal$1, null,
...
var Toaster = (function (_a) {
    ...
    return (React.createElement("div", { className: styles$2.toaster }, toasts.map(function (toast, i) {
        return (React.createElement(Toast, __assign({}, toast, { onHeightReceived: setHeight, onExitRequested: startExit, onRemoveRequested: removeToast, y: toasts.slice(0, i + 1).reduce(function (y, t) { return t.height + y + 5; }, 0), key: toast.id })));
    })));
});
var Toast = function (_a) {
    ...
    var _b = __read(React.useState(false), 2), paused = _b[0], setPaused = _b[1];
    var wrapper = React.useRef();
    ...
    return (React.createElement("div", { "data-flume-component": "toast", ref: wrapper, className: styles$2.toast, "data-type": type, style: { transform: "translateY(-".concat(y, "px)") }, "data-exiting": exiting, onAnimationEnd: handleAnimationEnd, onMouseEnter: stopTimer, onMouseLeave: resumeTimer, role: "alert" },
        title ? React.createElement("span", { "data-flume-component": "toast-title", className: styles$2.title }, title) : null,
        ...
        React.createElement("button", { "data-flume-component": "toast-close", className: styles$2.exitButton, onClick: function () {
                stopTimer();
                onExitRequested(id);
            } }, "\u2715")));
};

var styles$1 = ".svgWrapper{\r\n  position: absolute;\r\n  left: 0px;\r\n  height: 0px;\r\n}\r\n";
...
var addConnection = function (nodes, input, output, portTypes) {
    var _a, _b, _c;
    var newNodes = __assign(__assign({}, nodes), (_a = {}, _a[input.nodeId] = __assign(__assign({}, nodes[input.nodeId]), { connections: __assign(__assign({}, nodes[input.nodeId].connections), { inputs: __assign(__assign({}, nodes[input.nodeId].connections.inputs), (_b = {}, _b[input.portName] = __spreadArray(__spreadArray([], __read((nodes[input.nodeId].connections.inputs[input.portName] || [])), false), [
                {
                    nodeId: output.nodeId,
                    portName: output.portName
                }
            ], false), _b)) }) }), _a[output.nodeId] = __assign(__assign({}, nodes[output.nodeId]), { connections: __assign(__assign({}, nodes[output.nodeId].connections), { outputs: __assign(__assign({}, nodes[output.nodeId].connections.outputs), (_c = {}, _c[output.portName] = __spreadArray(__spreadArray([], __read((nodes[output.nodeId].connections.outputs[output.portName] ||
                [])), false), [
                {
                    nodeId: input.nodeId,
...
var removeConnection = function (nodes, input, output) {
    ...
    var _c = inputNode.connections.inputs, _d = input.portName; _c[_d]; var newInputNodeConnectionsInputs = __rest(_c, [typeof _d === "symbol" ? _d : _d + ""]);
    var newInputNode = __assign(__assign({}, inputNode), { connections: __assign(__assign({}, inputNode.connections), { inputs: newInputNodeConnectionsInputs }) });
    ...
    var newOutputNode = __assign(__assign({}, outputNode), { connections: __assign(__assign({}, outputNode.connections), { outputs: __assign(__assign({}, outputNode.connections.outputs), (_a = {}, _a[output.portName] = filteredOutputNodes, _a)) }) });
    return __assign(__assign({}, nodes), (_b = {}, _b[input.nodeId] = newInputNode, _b[output.nodeId] = newOutputNode, _b));
};
var getFilteredTransputs = function (transputs, nodeId) {
    return Object.entries(transputs).reduce(function (obj, _a) {
        var _b = __read(_a, 2), portName = _b[0], transput = _b[1];
...
var removeNode = function (startNodes, nodeId) {
    var _a = startNodes, _b = nodeId; _a[_b]; var nodes = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
    nodes = Object.values(nodes).reduce(function (obj, node) {
        obj[node.id] = __assign(__assign({}, node), { connections: removeConnections(node.connections, nodeId) });
        return obj;
    }, {});
...
var reconcileNodes = function (initialNodes, nodeTypes, portTypes, context) {
    var nodes = __assign({}, initialNodes);
    ...
    var reconciledNodes = Object.values(nodes).reduce(function (nodesObj, node) {
        ...
        var newInputData = __assign(__assign({}, defaultInputData), currentInputData);
        nodesObj[node.id] = __assign(__assign({}, node), { inputData: newInputData });
        return nodesObj;
    }, {});
...
var getInitialNodes = function (initialNodes, defaultNodes, nodeTypes, portTypes, context) {
    ...
    return __assign(__assign({}, reconciledNodes), defaultNodes.reduce(function (nodes, dNode, i) {
...
var nodesReducer = function (nodes, action, _a, dispatchToasts) {
    ...
    if (dispatchToasts === void 0) { dispatchToasts = undefined; }
    switch (action.type) {
        case "ADD_CONNECTION": {
        ...
        case "DESTROY_TRANSPUT": {
            ...
            return connections.reduce(function (nodes, cnx) {
                var _a = __read(transputType_1 === 'input' ? [transput_1, cnx] : [cnx, transput_1], 2), input = _a[0], output = _a[1];
                var id = output.nodeId + output.portName + input.nodeId + input.portName;
                delete cache.current.connections[id];
                deleteConnection({ id: id });
                return removeConnection(nodes, input, output);
        ...
        case "ADD_NODE": {
            ...
            return __assign(__assign({}, nodes), (_b = {}, _b[newNodeId] = newNode, _b));
        }
        case "REMOVE_NODE": {
        ...
        case "HYDRATE_DEFAULT_NODES": {
            var newNodes = __assign({}, nodes);
            for (var key in newNodes) {
                if (newNodes[key].defaultNode) {
                    var newNodeId = nanoid(10);
                    var _g = newNodes[key], id = _g.id, defaultNode = _g.defaultNode, node = __rest(_g, ["id", "defaultNode"]);
                    newNodes[newNodeId] = __assign(__assign({}, node), { id: newNodeId });
                    delete newNodes[key];
                }
            }
            return newNodes;
        ...
        case "SET_PORT_DATA": {
            ...
            var newData = __assign(__assign({}, nodes[nodeId].inputData), (_c = {}, _c[portName] = __assign(__assign({}, nodes[nodeId].inputData[portName]), (_d = {}, _d[controlName] = data, _d)), _c));
            if (setValue) {
                newData = setValue(newData, nodes[nodeId].inputData);
            }
            return __assign(__assign({}, nodes), (_e = {}, _e[nodeId] = __assign(__assign({}, nodes[nodeId]), { inputData: newData }), _e));
        }
        case "SET_NODE_COORDINATES": {
            var x = action.x, y = action.y, nodeId = action.nodeId;
            return __assign(__assign({}, nodes), (_f = {}, _f[nodeId] = __assign(__assign({}, nodes[nodeId]), { x: x, y: y }), _f));
        }
        default:
            return nodes;
    }
...
var setComment = function (comments, id, merge) {
    var _a;
    return (__assign(__assign({}, comments), (_a = {}, _a[id] = __assign(__assign({}, comments[id]), merge), _a)));
};
var commentsReducer = (function (comments, action) {
    ...
    switch (action.type) {
        case "ADD_COMMENT": {
            ...
            return __assign(__assign({}, comments), (_a = {}, _a[comment_1.id] = comment_1, _a));
        }
        case "REMOVE_COMMENT_NEW":
            var _c = comments[action.id]; _c.isNew; var comment = __rest(_c, ["isNew"]);
            return __assign(__assign({}, comments), (_b = {}, _b[action.id] = comment, _b));
...
var toastsReducer = (function (toasts, action) {
    ...
    switch (action.type) {
        ...
        case "SET_HEIGHT": {
            ...
            return __spreadArray(__spreadArray(__spreadArray([], __read(toasts.slice(0, index)), false), [
                __assign(__assign({}, toasts[index]), { height: action.height })
            ], false), __read(toasts.slice(index + 1)), false);
        }
        case "SET_EXITING": {
            var index = toasts.findIndex(function (t) { return t.id === action.id; });
            return __spreadArray(__spreadArray(__spreadArray([], __read(toasts.slice(0, index)), false), [
                __assign(__assign({}, toasts[index]), { exiting: true })
            ], false), __read(toasts.slice(index + 1)), false);
        }
        case "REMOVE_TOAST": {
            var index = toasts.findIndex(function (t) { return t.id === action.id; });
            return __spreadArray(__spreadArray([], __read(toasts.slice(0, index)), false), __read(toasts.slice(index + 1)), false);
        }
        default:
            return toasts;
    }
...
var stageReducer = (function (state, incomingAction) {
    ...
    switch (action.type) {
        case 'SET_SCALE':
            return __assign(__assign({}, state), { scale: action.scale });
        case 'SET_TRANSLATE':
            return __assign(__assign({}, state), { translate: action.translate });
        case 'SET_TRANSLATE_SCALE':
            return __assign(__assign({}, state), { translate: action.translate, scale: action.scale });
        default:
            return state;
    }
});
...
var styles = ".dragWrapper{\r\n  z-index: 9999;\r\n  position: absolute;\r\n  left: 0px;\r\n  top: 0px;\r\n}\r\n.debugWrapper{\r\n  display: flex;\r\n  position: absolute;\r\n  left: 10px;\r\n  bottom: 10px;\r\n  gap: 15px;\r\n}\r\n";

var defaultContext = {};
var NodeEditorInner = function (_a, ref) {
    ...
    var _l = __read(React.useState(), 2), sideEffectToasts = _l[0], setSideEffectToasts = _l[1];
    var _m = __read(React.useReducer(toastsReducer, []), 2), toasts = _m[0], dispatchToasts = _m[1];
    var _o = __read(React.useReducer(connectNodesReducer(nodesReducer, { nodeTypes: nodeTypes, portTypes: portTypes, cache: cache, circularBehavior: circularBehavior, context: context }, setSideEffectToasts), {}, function () { return getInitialNodes(initialNodes, defaultNodes, nodeTypes, portTypes, context); }), 2), nodes = _o[0], dispatchNodes = _o[1];
    var _p = __read(React.useReducer(commentsReducer, initialComments || {}), 2), comments = _p[0], dispatchComments = _p[1];
    React.useEffect(function () {
        dispatchNodes({ type: "HYDRATE_DEFAULT_NODES" });
    }, []);
    var _q = __read(React.useState(true), 2), shouldRecalculateConnections = _q[0], setShouldRecalculateConnections = _q[1];
    var _r = __read(React.useReducer(stageReducer, {
        scale: typeof initialScale === "number" ? lodashExports.clamp(initialScale, 0.1, 7) : 1,
        translate: { x: 0, y: 0 }
    }), 2), stageState = _r[0], dispatchStageState = _r[1];
...
var NodeEditor = React.forwardRef(NodeEditorInner);
